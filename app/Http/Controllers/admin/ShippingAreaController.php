...
class ShippingAreaController extends Controller
{
    ...
    {
        return view('admin.shipping-area.index',[
    ...
    {
        return view('admin.shipping-area.add');
    }
    ...
    public function show(string $id)
    {
        ...
        return redirect('/shipping-area')->with('message', 'Shipping Area Status Updated Successfully');
    }
    ...
    {
        return view('admin.shipping-area.edit',[
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect('shipping-area')->with('message', 'Shipping Area Info Updated Successfully');
    }
